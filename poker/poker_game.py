...
class GamePlayers:
    ...
    def count_active_with_money(self):
        ...
        return len(list(filter(lambda player: player.money > 0, self.active)))
...
class GamePots:
    ...
    def add_bets(self, bets):
        ...
        players = sorted(
            ...
            key=cmp_to_key(lambda player1, player2: cmp(bets[player1.id], bets[player2.id]))
        )
